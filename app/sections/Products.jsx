...
const Products = () => {
  return (
    <div className='pt-40 flex flex-col max-w-7xl mx-auto md:w-[90dvw]'>
      <h6 className='text-6xl md:text-8xl text-center md:pr-0 pr-4'>
        <span className='text-[#344CB7]'>Janelas e Portas</span> PVC
      </h6>
      <p className='self-left text-xl text-left py-7 pt-40 md:pl-0 pl-6 md:max-w-[80%] max-w-[90%]'>
      <span className='text-2xl font-bold'>Janelas PVC</span> <br />
      As janelas em PVC melhoram o isolamento térmico e acústico, aumentando a eficiência energética da casa. Para ajudar na escolha, entre em contato com a Janeland. <br />
      <p>&nbsp; </p>
      <span className='text-2xl font-bold'>Portas PVC</span> <br />
      Nosso catálogo de portas exteriores em PVC oferece uma grande diversidade de modelos e soluções. Na Janeland, comercializamos portas em PVC aos melhores preços do mercado, garantindo sua satisfação. <br />
      <p>&nbsp; </p>
      ...
      <div className='flex md:flex-row flex-col  md:gap-20 gap-10 justify-between mx-auto max-w-7xl'>
        ...
        <div className='flex flex-col items-center bg-white p-2 rounded-lg'>
          ...
          <p className='max-w-sm text-white text-left text-lg pl-5 pt-5'>
            <span className='font-extrabold text-2xl' >A70</span>  <br /> Sistema batente de 70 mm de profundidade de aro fixo e uma capacidade máxima para envidraçados de 40 mm. As 5 câmaras no perfil conferem-lhe uma grande eficiência energética.
          </p>
        </div>
        <div className='flex md:w-[50vw] w-[90vw] flex-col items-center bg-[#344CB7] rounded-lg py-8 px-4'>
        <div className='flex flex-col items-center bg-white p-2 rounded-lg'>
